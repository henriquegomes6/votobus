...
public class NovoMundo {
    ...
    public List<horario> segSexI() {
        ...
        lst.add(new horario("07:37"));
        lst.add(new horario("08:59"));
        ...
        lst.add(new horario("19:48"));
        lst.add(new horario("21:00"));
        lst.add(new horario("22:15","Atende primeiro o Jd Tatiana, chega na escola 22:55/23:00 aguarda a saida dos alunos, e em seguida segue para o Jd. Novo Mundo, retornando ao itinerario normal via Pq. Bela Vista."));
        return lst;
    }
    ...
    public List<horario> segSexO() {
        ...
        lst.add(new horario("08:07"));
        lst.add(new horario("09:29"));
        lst.add(new horario("10:49"));
        lst.add(new horario("12:09"));
        lst.add(new horario("13:29"));
        lst.add(new horario("14:49"));
        lst.add(new horario("16:11"));
        lst.add(new horario("17:35"));
        lst.add(new horario("18:59"));
        lst.add(new horario("20:13"));
        lst.add(new horario("21:25"));
